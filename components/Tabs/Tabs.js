class TabLink {
  ...
  selectTab(event){
    ...
    tabs.forEach(tab => tab.classList.remove('active-tab'))   //!!!!!might need to remove array.from
    ...
    cards.forEach(card => card.style.display = "none")    //!!!!!might need to remove array.from
