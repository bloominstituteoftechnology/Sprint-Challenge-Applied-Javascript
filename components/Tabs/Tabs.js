class TabCard {
  ...
  selectCard(){
    // show the card
    this.element.addClass("show"); // show is just a place holder at the moment
  }
  deselectCard(){
    // hide the card
    this.element.removeClass("show");  // show is just a place holder at the moment
  }
}
...
class Tabs {
  ...
  getCards(data){
    ...
    if(data === "all") {
      ...
      return this.element.find(`[data-tab = '${data}']`);
    }
  }
}
