class TabLink {
  constructor(tabElement){
    ...
    // We now have an array of 15 cards.
  ...
  selectTab(){
    ...
    tabs.forEach( tab => tab.classList.remove('active-tab') ); // always remove first
    ...
    this.tabElement.classList.add('active-tab'); // now we add .active-tab to the tab link that is clicked
