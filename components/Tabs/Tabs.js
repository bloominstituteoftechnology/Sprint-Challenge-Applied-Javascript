class TabLink {
  constructor(element){
    ...
    let tab = this.tabData
    // console.log(this.tabData)
    const cardData = Array.from(this.element.parentNode.parentNode.parentNode.children[3].children);
    ...
    // cardData.forEach(function(el){
    //   if(tab === 'all'){
    //     this.cards = document.querySelectorAll('.card');
    //   }
    //     else if(tab === el.dataset.tab){
    //     let correctCards = [];
    //     correctCards.push(el)
    //     this.cards = correctCards;
