...
class TabCard {
  constructor(element){
    ...
    this.element = element;
    this.cardData = this.element.dataset.tab;
  }
  selectCard(){
    // Update the style of this.element to display = null
    this.element.style.display = "null";
    let selectedTabData = document.querySelector(".active-tab").dataset.tab;
    if(selectedTabData === "all") {
        this.element.style.display = "block";
    }   else if(selectedTabData === this.cardData)  {
        this.element.style.display = "block";
    }
  }
}
