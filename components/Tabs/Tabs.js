class TabCard {
  ...
  selectCard(){
    // show the card
    //this.element.show("card");
    this.element.addClass("card");
  }
  deselectCard(){
    // hide the card
    //this.element.hide("card");
...
class TabLink {
  constructor(element, parent){
    ...
    this.cards = parent.getCards(this.element.data('tab'));
    ...
    this.cards.map(function(_, card) {
  ...
  selectTab(){
    ...
    this.cards.each(function() {
      return new TabCard(this.cards).selectCard();
    });
  ...
  deselectTab(){
    ...
    this.cards.each(function() {
      return new TabCard(this.cards).deselectCard();
    });
  }
}
