class TabLink {
  constructor(element){
    ...
    if(this.tabData === 'all'){
      ...
      console.log(this.tabData + ': ' + this.cards.length);
    }
  ...
  selectTab(){
    ...
    tabs.forEach(indexedTab => indexedTab.classList.remove('active-tab'));
...
tabs = Array.from(tabs).map(individualTab => new TabLink(individualTab));
