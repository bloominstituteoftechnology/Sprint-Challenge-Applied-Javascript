class TabLink {
  constructor(tabElement){
    ...
    // Get the `data-tabname` value from this.tabElement and store it here
    this.tabData = this.tabElement.dataset.tabname;
    ...
    if(this.tabData === 'all'){
      ...
      this.cards = document.querySelectorAll(`.card[data-tabname='${this.tabData}']`);;
    }
