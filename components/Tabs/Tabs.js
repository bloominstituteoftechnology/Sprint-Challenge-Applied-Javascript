class TabLink {
  ...
  selectTab(){
    ...
    // Notice we are looping through the this.cards array and invoking selectCard() from the TabCard 
    // class, nothing to update here
...
// Map over the array and convert each tab reference into a new TabLink object.  Pass in the tab object 
// to the Tabs class.
