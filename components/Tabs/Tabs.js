class TabLink {
  ...
  console.log(this.cardElements)
   if(this.cardElements[i]){
    ...
    this.element.addEventListener('click',() => {this.selectCard(event) });
};
