class TabLink {
  ...
  selectTab(){
    ...
    // Not sure why this works and card.style.display= "none" does not.
...
class TabCard {
  ...
  selectCard(){
    ...
    // I had it as this.element.style.display="null". It hid all the cards permentently. Not sure why this works, but my way didn't. 
