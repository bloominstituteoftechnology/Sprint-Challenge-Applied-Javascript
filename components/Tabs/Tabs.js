...
class TabLink {
  constructor(element, parent){
    ...
    this.element.click(() => {this.element.selectTab(this)});
  }
  ...
  selectTab(){
    ...
    this.cards.each(() => {this.card.selectCard()});
  }
  ...
  deselectTab(){
    ...
    this.cards.each(() => {this.element.deselectCard()});
  }
}
