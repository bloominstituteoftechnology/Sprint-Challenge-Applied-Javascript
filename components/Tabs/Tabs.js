class Tabs {
  ...
  getCards(data){
    ...
    if(data === 'all') 
   { //document.querySelectorAll(".tab-item[data-tab='all']")
...
class TabLink {
  ...
  selectTab(){
    ...
    //from the TabCard class, nothing to update here
...
class TabCard {
  ...
  selectCard(){
    ...
    this.element.style.display = null; //look over syntax
  }
  deselectCard(){
    // Update the style of this.element to display = "none"
    this.element.style.display = "none"; //look over syntax
  }
}

// Create a reference to ".tabs"
let tabs = document.querySelectorAll(".tabs");
// Map over the array and convert each tab reference into a new Tabs object.  
