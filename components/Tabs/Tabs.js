class TabLink {
  constructor(element){
    ...
    // Find all elements with the .card class in index.html that correspond to the
    // tab data attribute
    ...
    // Map over the cards array and convert each card element into a new instance of
    // the TabCard class. 
  ...
  selectTab(){
    ...
    tabs.forEach((el) => el.classList = 'tab')
