...
// Select all classes named 'tab' and assign the nodeList to tabs variable
let tabs = document.querySelectorAll('.tab');

// Iterate through tabs and construct a new TabLink, passing in each tab element as a parameter.
tabs.forEach(elem => new TabLink(elem));
