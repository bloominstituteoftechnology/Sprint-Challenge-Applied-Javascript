...
let tabs = document.querySelectorAll(".tab"); // This line is correct
// Map over the array and convert each tab reference into a new TabLink object.  Pass in the tab object to the Tabs class.
tabs = Array.from(tabs).map(tab => { return new TabLink(tab); }); // this line is correct
//console.log("LINE 65: " + tabs[1].tabData);
