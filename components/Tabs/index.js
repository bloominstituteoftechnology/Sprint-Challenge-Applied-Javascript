...
function createTopic(axiosData){
    const trendingTopicsTabs = document.createElement("div");
    trendingTopicsTabs.classList.add("tab");
    trendingTopicsTabs.textContent = axiosData;

    return trendingTopicsTabs;
}