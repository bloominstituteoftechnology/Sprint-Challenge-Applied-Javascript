...
1.  What is the DOM? --- the Document object model that can be edited using JS
2.  What is an event?--- An action that is created in JS that is invoked when a user is using the HTML
3.  What is an event listener? ---a method that gets invoked when the user does a certain action
4.  What is jQuery? - a library
5.  What is a component? - HTML + CSS + JS = a created component made with class/constructors with methods
